...
class crud_ops ():
   ...
   entry_comment TEXT)""")
    ...
    def create_entry (self, entry_data):
        ...
        self.__cursor.execute('''INSERT INTO my_log(entry_name,  entry_date, entry_time, entry_email, entry_comment) VALUES (:entry_name,  :entry_date, :entry_time, :entry_email, :entry_comment)''',entry_data)
...
test_data = {'entry_name': 'Sven', 'entry_comment':'Hallo Welt', 'entry_time': '12:20', 'entry_email':'scen@dfg.de', 'entry_date': '150505'}
